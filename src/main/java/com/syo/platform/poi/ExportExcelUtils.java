...
public class ExportExcelUtils {
	...
	private static int writeTitlesToExcel(Workbook wb, Sheet sheet, List<String> titles) {
        ...
        setBorder(titleStyle, BorderStyle.THIN, HSSFColor.HSSFColorPredefined.GREY_40_PERCENT.getIndex());
	...
	private static int writeRowsToExcel(Workbook wb, Sheet sheet, List<List<Object>> rows, int rowIndex) {
        ...
        setBorder(dataStyle, BorderStyle.THIN, HSSFColor.HSSFColorPredefined.GREY_40_PERCENT.getIndex());
