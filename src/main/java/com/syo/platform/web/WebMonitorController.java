...
public class WebMonitorController {
	...
	public String dbmonitor(String vague, Model model) {
		model.addAttribute("configs", webMonitorService.findConfig(vague));
	...
	@ResponseBody
	public String saveHostConfig(WebMonitorConfig config) {
		webMonitorService.saveConfig(config);
//		return "SUCCESS";
		return "操作成功";
	}
	...
	@ResponseBody
	public WebMonitorConfig findConfigById(@PathVariable("id")String id) {
		return webMonitorService.findConfigById(id);
	}
	
	@RequestMapping("/config_del/{id}")
	@ResponseBody
	public String del(@PathVariable("id")String id) {
		webMonitorService.deleteConfig(id);
//		return "SUCCESS";
		return "操作成功";
	}
	...
	public String startMonitor(@PathVariable("id")String id) {
		webMonitorService.startMonitor(id);
//		return "SUCCESS";
		return "操作成功";
	}
	...
	public String stopMonitor(@PathVariable("id")String id) {
		webMonitorService.stopMonitor(id);
//		return "SUCCESS";
		return "操作成功";
	}
	...
	public String startMonitorBatch(@PathVariable("ids")String ids) {
		...
		int successCount = 0;
		for(String id : idArr) {
			boolean success = webMonitorService.startMonitor(id);
			if(success) {
				successCount ++;
			}
		}
	...
	public String stopMonitorBatch(@PathVariable("ids")String ids) {
		...
		int successCount = 0;
		for(String id : idArr) {
			boolean success = webMonitorService.stopMonitor(id);
			if(success) {
				successCount ++;
			}
		}
	...
	public String switchMonitor(@PathVariable("id")String id) {
		webMonitorService.switchMonitor(id);
//		return "SUCCESS";
		return "操作成功";
	}
	...
	public boolean doMonitor(@PathVariable("id")String id) {
		return webMonitorService.monitor(id);
	}
	...
	public String setBind(@PathVariable("configId")String configId, @PathVariable("equipmentId")String equipmentId) {
		webMonitorService.saveBind(configId, equipmentId);
//		return "SUCCESS";
		return "操作成功";
	}
}
