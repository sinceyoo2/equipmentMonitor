...
public class DataBaseMonitorConfig {
	...
	public String toString() {
		return "DataBaseMonitorConfig [id=" + id + ", name=" + name + ", ipAddress=" + ipAddress + ", dbPort=" + dbPort
				...
				+ ", errorContinued=" + errorContinued + ", dbDriver=" + dbDriver + ", dbURL=" + dbURL + ", dbVendor="
				+ dbVendor + ", taskType=" + taskType + ", taskHours=" + taskHours + ", taskWeeks=" + taskWeeks
