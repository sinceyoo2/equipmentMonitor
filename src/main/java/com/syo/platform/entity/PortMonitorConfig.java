...
@Entity
@Table(name="t_monitor_protconfig")
public class PortMonitorConfig {
	...
	public String toString() {
		return "PortMonitorConfig [id=" + id + ", name=" + name + ", ipAddress=" + ipAddress + ", port=" + port
				+ ", serviceName=" + serviceName + ", errorContinued=" + errorContinued + ", cron=" + cron
