...
@Entity
@Table(name="t_monitor_webconfig")
public class WebMonitorConfig {
	...
	public String getWebServerVendor() {
		return webServerVendor;
	}

	public void setWebServerVendor(String webServerVendor) {
		this.webServerVendor = webServerVendor;
	}
	...
	public String toString() {
		return "WebMonitorConfig [id=" + id + ", name=" + name + ", ipAddress=" + ipAddress + ", port=" + port
				+ ", webURL=" + webURL + ", webServerVendor=" + webServerVendor + ", serviceName=" + serviceName
				+ ", errorContinued=" + errorContinued + ", cron=" + cron + ", taskType=" + taskType + ", taskHours="
				+ taskHours + ", taskWeeks=" + taskWeeks + ", taskDays=" + taskDays + ", emailReceivers="
				+ emailReceivers + ", smsReceivers=" + smsReceivers + ", remarks=" + remarks + ", createTime="
				+ createTime + ", lastTime=" + lastTime + ", nextTime=" + nextTime + ", status=" + status
				+ ", lastUpdateTime=" + lastUpdateTime + ", lastResult=" + lastResult + "]";
	}
